...
export default {
  ...
  methods: {
    ...
    texti(){
        ...
        let Practice= "/user/practice/" + token + '/' + market;
        let Trade = "/user/trade/" + token + '/' + market;
        let Exchange = "/user/exchange/" + token + '/' + market;
        let bot = "/user/bot/" + token + '/' + market;
        if (urll == 'practice') {
            this.textii = '<a href="'+Practice+'"><button class="mb-1 me-1 btn btn-sm btn-warning bi bi-bar-chart iconLeft"> Practice</button></a><a href="'+Exchange+'"><button class="mb-1 btn btn-sm btn-warning bi bi-bar-chart iconLeft"> Exchange</button></a>'
        } else if (urll == 'trade') {
            this.textii = '<a href="'+Trade+'"><button class="mb-1 me-1 btn btn-sm btn-warning bi bi-bar-chart iconLeft"> Trade</button></a><a href="'+Exchange+'"><button class="mb-1 btn btn-sm btn-warning bi bi-bar-chart iconLeft"> Exchange</button></a>'
        } else if (urll == 'bot') {
            this.textii = '<a href="'+bot+'"><button class="mb-1 me-1 btn btn-sm btn-warning bi bi-bar-chart iconLeft"> New Bot</button></a><a href="'+Exchange+'"><button class="mb-1 btn btn-sm btn-warning bi bi-bar-chart iconLeft"> Exchange</button></a>'
        } else if (urll == 'exchange') {
            this.textii = '<a href="'+Exchange+'"><button class="btn btn-sm btn-warning bi bi-bar-chart iconLeft"> Exchange</button></a>'
        }
    },
