...
import OptionsPageAdmin from './OptionsPageAdmin.vue';
...
export default {
  ...
  methods: {
    ...
    setupRoutes() {
      ...
      this.$router.on( '/optionsadmin', () => { this.showModal( 'OptionsPageAdmin', 'Admin Options & Settings' ) } );
      // symbol modal route
    ...
    onTickerError( e ) {
      let info = String( e.message || 'Your country in ban list, Please try using VPN to access our services.' );
      this.tickerStatus = 0;
