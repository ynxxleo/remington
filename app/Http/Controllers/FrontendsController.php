...
class FrontendsController extends Controller
{
    ...
    public function index()
    {
        ...
        $templates = FrontendTemplates::latest()->paginate(getPaginate(10));
    ...
    {
        $page_title = '';
        $pages = FrontendPages::where('template_id',$template_id)->latest()->paginate(getPaginate(10));
        $empty_message = 'No Data Found';
    ...
    public function sections($template_id,$page_id)
    {
        ...
        $sections = FrontendSections::where('template_id',$template_id)->where('page_id',$page_id)->latest()->paginate(getPaginate(10));
        $empty_message = 'No Data Found';
