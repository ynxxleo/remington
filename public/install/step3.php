...
<html>
  <head>
    <meta charset="utf-8"/>
    <title>Bicrypto Stage 3 : Modules Installer</title>
      ...
      <div class="section">
        <div class="columns is-centered">
          <div class="column is-two-fifths">
            <center>
              <h1 class="title" style="padding-top: 20px;">Bicrypto Stage 3 <br/> Modules Installer</h1><br>
            </center>
            </center>
            <div class="box">
              <div class='content'>
                <?php if($update_data['status']){ ?>
                <p>Installation Modules might take some time!</p><?php
                  $update_id = null;
                  $has_sql = null;
                  $version = null;
