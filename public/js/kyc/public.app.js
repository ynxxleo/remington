...
(function (a) {
    ...
    var d = a("form#kyc_submit");
    0 < d.length && ajax_form_submit(d, !1);
    var e = a(".upload-zone");
    if (0 < e.length) {
        Dropzone.autoDiscover = !1;
        var f = a("input#file_uploads").val(),
            g = a("meta[name=\"csrf-token\"]").attr("content"),
            h = ".document_one";
        if (0 < a(h).length) {
            var i = new Dropzone(h, {
                url: f,
                uploadMultiple: !1,
                maxFilesize: 5.1,
                maxFiles: 1,
            ...
            i.on("sending", function (a, b, c) {
                c.append("docType", "doc-one")
            }).on("success", function (b, c) {
                cl(c);
                var d = c.message;
                "error" == c.msg ? (alert(d), i.removeFile(b)) : a("input[name=\"document_one\"]").val(c.file_name)
            }).on("removedfile", function (b) {
                var c = a("input[name=\"document_one\"]").val();
                0 < c.length && b.accepted && a.post(f, {
                    _token: csrf_token,
                    action: "delete",
                    file: c
                }).done(b => {
        ...
        if (0 < a(".document_two").length) {
            var j = new Dropzone(".document_two", {
                url: f,
                uploadMultiple: !1,
                maxFilesize: 5.1,
                maxFiles: 1,
            ...
            j.on("sending", function (a, b, c) {
                c.append("docType", "doc-two")
            }).on("success", function (b, c) {
                cl(c);
                var d = c.message;
                "error" == c.msg ? (alert(d), j.removeFile(b)) : a("input[name=\"document_two\"]").val(c.file_name)
            }).on("removedfile", function (b) {
        ...
        if (0 < a(".document_upload_hand").length) {
            var k = new Dropzone(".document_upload_hand", {
                url: f,
                uploadMultiple: !1,
                maxFilesize: 5.1,
                maxFiles: 1,
            ...
            k.on("sending", function (a, b, c) {
                c.append("docType", "doc-hand")
            }).on("success", function (b, c) {
                cl(c);
                var d = c.message;
                "error" == c.msg ? (alert(d), k.removeFile(b)) : a("input[name=\"document_image_hand\"]").val(c.file_name)
            }).on("removedfile", function (b) {
