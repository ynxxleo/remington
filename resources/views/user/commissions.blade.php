                    ...
                    <tbody>
                        @forelse($commissions as $commission)
                            <tr>
                                ...
                                <td data-label="{{ __('locale.Amount')}}">{{getAmount($commission->amount)}} {{__($general->cur_text)}}</td>
                                <td data-label="{{ __('locale.Post Balance')}}">{{ getAmount($commission->post_balance) }} {{__($general->cur_text)}}</td>
