...
<div class="card col-lg-6 col-md-6">
    <div class="card-header">
        <h5 class="m-0">@lang('Current Balance') <span class="text-base">{{ getAmount(auth()->user()->balance)}}
                {{ __($general->cur_text) }}</span></h5>
    </div>
    <div class="card-content mx-2">
        <ul>
            ...
            <li>
                {{ __('locale.From Wallet')}}: <span class="text-primary">{{$withdraw->address}}</span>
            </li>
            {{-- <li>
            ...
            <li>
                {{ __('locale.Wallet Will Be Charged')}}: <span
                    class="text-primary">{{getAmount($withdraw->amount + $withdraw->charge) }}
                    {{ $withdraw->symbol }}</span>
            </li>
        </ul>
            ...
            <div class="col">
                <div class="fileinput fileinput-new " data-provides="fileinput">
                    <div class="fileinput-new thumbnail withdraw-thumbnail" data-trigger="fileinput">
                        <img class="w-100" src="{{ getImage('/')}}" alt="{{ __('locale.image')}}">
                    </div>
                    ...
                    <div class="img-input-div">
                        <span class="btn btn-info btn-file">
                            ...
                            <input type="file" name="{{$k}}" accept="image/*" @if($v->validation == "required") required
                            @endif>
                        </span>
