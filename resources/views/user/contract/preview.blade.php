    ...
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                        Profit/Loss:<br><div class="@if($contract->result == 1) text-success @elseif($contract->result == 2) text-danger @else text-secondary @endif"><b>@if($contract->result == 1)+ {{ $contract->amount * 0.87 }}@elseif($contract->result == 2) - {{ $contract->amount * 0.87 }}@else Draw @endif</b></div>
                    </div>
                    <div class="col">
                        Sell price:<br><b>{{ $contract->amount + ($contract->amount * 0.87) }}</b>
                    </div>
                </div>
                <div class="row mt-1">
                    <div class="col">
                    ...
                    <div class="col">
                        Payout limit:<br><b>{{ $contract->amount * 0.87 }}</b>
                    </div>
                </div>
            </div>
        </div>
