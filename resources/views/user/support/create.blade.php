        ...
        <div class="card-body">
                    ...
                    @csrf
                        <div class="form-group mb-1 col-sm-6">
                            ...
                            <input type="text" id="name" name="name" class="form-control " value="{{$user->fullname}}" readonly>
                        </div>
                        <div class="form-group mb-1 col-sm-6">
                        ...
                        <div class="form-group mb-1 col-sm-12">
                            ...
                            <input type="text" id="subject" name="subject" class="form-control " placeholder="{{ __('locale.Enter Subject')}}" required="">
                        </div>
                        <div class="form-group mb-1 col-sm-12">
