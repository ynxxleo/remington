        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card card-congratulation-medal" style="max-height:22vh;">
                <div class="card-body">
                    ...
                    <a href="{{route('user.exchange.market')}}" type="button" class="mt-3 btn btn-primary">{{__('locale.Start Exchanging')}}</a>
                    <img src="https://app.spotalertweb.com/2.png')}}" class="congratulation-medal"
                        alt="Medal Pic" />
                </div>
            </div>
                    ...
                    <div class="transaction-item">
                        ...
                        <div class="fw-bolder">
                            ...
                            <a href="{{route('user.exchange.now', [$wallet->symbol, 'USDT'])}}"><button
                                    class="btn btn-sm btn-primary">{{__('locale.Exchange')}}</button></a>
                            @else
                            @endif
                        </div>
                    </div>
