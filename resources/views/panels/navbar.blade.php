              ...
              <ul class="nav navbar-nav align-items-center ms-auto">
                  <li class="nav-item dropdown dropdown-notification me-25">
                      <a class="nav-link ringing nova-notification-button d-flex" style="display:grid!important" href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false" aria-label="Notifications">
                          <span class="nova-bell-fallback" aria-hidden="true">&#128276;</span><svg class="nova-bell-svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M18 9a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9M10 21h4" fill="none" stroke="#f4f8f6" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>
                  ...
                  <li class="nav-item dropdown dropdown-user">
                      <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user"
                          ...
                          <span class="avatar">
                              <img class="round justifinedProfileSetImageCreated2" src="{{ Auth::user() ? Auth::user()->profile_photo_url : asset('images/portrait/small/avatar-s-11.jpg') }}" alt="avatar" height="40" width="40">
