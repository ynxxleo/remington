        ...
        <div class="card col-lg-6 col-md-6">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{$category->edit_url()}}"><button class="btn btn-primary btn-sm">Edit Category</button></a>
                </div>
            </div>
            <div class="card-footer">
                <form
                        ...
                        method="post"
                        action="{{route("admin.blogetc.admin.categories.destroy_category", $category->id)}}"
                        class="float-right">
                    @csrf
                    @method('DELETE')
