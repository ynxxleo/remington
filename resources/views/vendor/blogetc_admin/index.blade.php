...
@section("blog")
    ...
    <div class="col-md-6 col-12">
        <div class="card">
          ...
          <div class="card-body">
            <h4 class="card-title">
              <a href="{{ $post->url() }}" class="blog-title-truncate text-body-heading"
                >{{ $post->title }}</a> {!!($post->is_published ? '<div class="badge rounded-pill bg-success fs-6">Published</div>' : '<div class="badge rounded-pill bg-danger fs-6">Not Published</div>')!!}
            </h4>
            ...
            <div class="d-flex justify-content-between align-items-center">
              <a class="col-sm-4 btn btn-primary btn-sm" href="{{ $post->url() }}" class="fw-bold">View Post</a>
              <a class="col-sm-4 btn btn-info btn-sm" href="{{$post->edit_url()}}" class="fw-bold">Edit Post</a>
