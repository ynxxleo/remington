    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 text-center @rtl text-md-end @else text-md-start @endrtl">
                <span class="py-2"
                    data-aos="@rtl fade-left @else fade-right @endrtl">{{$sections[0]->content->text1 }}</span>
                <h1 class="bold font-md display-lg-2 mt-3" data-aos="@rtl fade-left" @else fade-right @endrtl
                    data-aos-delay="100">{{$sections[0]->content->text2 }} <span
                        class="d-block">{{$sections[0]->content->text3 }}</span></h1>
                ...
                <div class="my-5" data-aos="@rtl fade-left" @else fade-right @endrtl data-aos-delay="400">
                    <a href="{{$sections[0]->content->btn1link }}"
                        class="btn btn-rounded btn-lg btn-primary px-4 mx-auto @rtl ms-md-0 @else me-md-0 @endrtl">{{$sections[0]->content->btn1 }}
            ...
            <div class="col-md-6 position-relative">
                ...
                <figure class="figure-box mockup cutout x2 bottom-right">
                    <div class="screens">
                        <img src="{{ asset($images[0]->image)}}" alt="..." data-aos="fade-down">
                        <img src="{{ asset($images[1]->image)}}" class="position-absolute"
                            data-aos="fade-up" data-aos-delay="200" alt="...">
                    </div>

                    <div class="promo-box card shadow-lg border-0" data-aos="fade-up" data-aos-delay="400">
                        <div class="card-body p-5 text-center">
                            <figure class="icon-xxl mx-auto">
                                <img src="{{ asset($images[2]->image)}}" alt="...">
                            </figure>

                            <p class="mt-4 text-muted mb-0">{{$sections[0]->content->text5 }}</p>
                            <hr class="my-3 mx-auto w-25">
                            <h6 class="h6 mb-0">{{$sections[0]->content->text6 }}</h6>
                        </div>
                    </div>
                </figure>
            </div>
...
<x-utils.container>
    ...
    <div class="row gap-y text-center @rtl text-md-end @else text-md-start @endrtl">
        <?php
        $features = [
        [ "icon" => "{$sections[5]->content->feature1icon }", "title" => "{$sections[5]->content->feature1title }" ],
        [ "icon" => "{$sections[5]->content->feature2icon }", "title" => "{$sections[5]->content->feature2title }" ],
        [ "icon" => "{$sections[5]->content->feature3icon }", "title" => "{$sections[5]->content->feature3title }" ],
        [ "icon" => "{$sections[5]->content->feature4icon }", "title" => "{$sections[5]->content->feature4title }" ],
        [ "icon" => "{$sections[5]->content->feature5icon }", "title" => "{$sections[5]->content->feature5title }" ],
        [ "icon" => "{$sections[5]->content->feature6icon }", "title" => "{$sections[5]->content->feature6title }" ]
        ]
        ?>
...
<!-- ./FAQs -->
<x-utils.container class="{{ $class ?? '' }}" container-class="{{ $containerClass ?? '' }}" id="faqs">
    <div class="row gap-y">
        <div class="col-md-4">
            ...
            <div class="accordion accordion-clean accordion-collapsed" id="faqs-accordion-2">
                ...
                @php($faqs = [
                    [
                        ...
                        "answer" => "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam ducimus ea facilis illum laboriosam, provident quidem recusandae sequi velit vero. Aliquid commodi eos esse exercitationem itaque iure iusto molestiae nemo."
                    ],[
                        ...
                        "answer" => "Definitely Yes, you can contact us to let us know your needs. If your suggestion represents any value to both we can include it as a part of the theme or you can request a custom build by an extra cost. Please note it could take some time in order for the feature to be implemented."
                    ]
                ])
                @foreach ($faqs as $faq)
                <div class="card">
