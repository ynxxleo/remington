...
<x-utils.container class="bg-light" container-class="bring-to-front py-0">
    <div class="shadow bg-contrast p-5 rounded">
        <div class="row gap-y align-items-center text-center @rtl text-lg-end @else text-lg-start @endrtl">
            <div class="col-12 col-md-6 py-4 px-5 @rtl b-md-l @else b-md-r @endrtl">
                ...
                <a href="javascript:;" class="mt-4 text-primary d-flex align-items-center">
                    <h4 class="@rtl ms-3 @else me-3 @endrtl">Join as Designer</h4>
                    <i class="fas fa-long-arrow-alt-end"></i>
                </a>
                <p class="mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores, consequuntur
                    fugit minima natus optio quisquam sint sunt? Earum harum in laudantium nobis obcaecati odio,
                    praesentium, quis sequi soluta vel veniam.</p>
            </div>
            ...
            <div class="col-12 col-md-6 py-4 px-5">
                ...
                <a href="javascript:;" class="mt-4 text-info d-flex align-items-center">
                    <h4 class="@rtl ms-3 @else me-3 @endrtl">Join as Developer</h4>
                    <i class="fas fa-long-arrow-alt-end"></i>
                </a>
                <p class="mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores, consequuntur
                    fugit minima natus optio quisquam sint sunt? Earum harum in laudantium nobis obcaecati odio,
