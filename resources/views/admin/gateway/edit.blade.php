                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-1">
                                ...
                                <input type="text" class="form-control" name="currency[{{ $currency_idx }}][min_amount]"
                                    value="{{ getAmount($gateway_currency->min_amount) }}" placeholder="0" required />
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="0"
                                    ...
                                    value="{{ getAmount($gateway_currency->max_amount) }}" required />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-1">
                                ...
                                <input type="text" class="form-control" placeholder="0"
                                    ...
                                    value="{{ getAmount($gateway_currency->fixed_charge) }}" required />
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="0"
                                    ...
                                    value="{{ getAmount($gateway_currency->percent_charge) }}" required />
                            </div>
                        </div>
                    </div>
                </div>
