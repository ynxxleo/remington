...
<div class="card">
    ...
    <form action="{{ route('admin.bot.store') }}" method="POST" enctype="multipart/form-data" id="newBot">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="input-group mb-1">
                        <input type="text" class="form-control" id="title" name="title" aria-label="Bot Title" aria-describedby="title" value="{{ old('title') }}">
                    </div>
                </div>
                <div class="col-lg-3">
                    <label for="perc">{{ __('locale.APR')}}</label>
                    <div class="input-group mb-1">
                        <input type="number" class="form-control"  id="perc" name="perc" aria-label="Bot APR" aria-describedby="perc" value="{{ old('perc') }}">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="input-group mb-1">
                        <input type="number" class="form-control"  id="fake" name="fake" aria-label="Bot Uses" aria-describedby="fake" value="{{ old('fake') }}">
            ...
            <div class="input-group mb-1">
                <input type="text" class="form-control"  id="desc" name="desc" aria-label="Bot Description" aria-describedby="desc" value="{{ old('desc') }}">
            </div>
            <div class="row">
                <div class="col-lg-3">
                    <label for="min_profit">{{ __('locale.Minimum Profit')}}</label>
                    <div class="input-group mb-1">
                        <input type="number" class="form-control"  id="min_profit" name="min_profit" aria-label="Minimum Profit" aria-describedby="min_profit" value="{{ old('min_profit') }}">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="input-group mb-1">
                        <input type="number" class="form-control"  id="max_profit" name="max_profit" aria-label="Maximum Profit" aria-describedby="max_profit" value="{{ old('max_profit') }}">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" onclick="$('#result_missedt').text($(this).text());$('#newBot').find('input[name=result_missed]').val($(this).data('result'));" data-result="1">{{ __('locale.Win')}}</a></li>
                            <li><a class="dropdown-item" onclick="$('#result_missedt').text($(this).text());$('#newBot').find('input[name=result_missed]').val($(this).data('result'));" data-result="2">{{ __('locale.Lose')}}</a></li>
                            <li><a class="dropdown-item" onclick="$('#result_missedt').text($(this).text());$('#newBot').find('input[name=result_missed]').val($(this).data('result'));" data-result="3">{{ __('locale.Draw')}}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3">
