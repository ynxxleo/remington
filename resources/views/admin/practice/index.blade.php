                ...
                <table class="table table-hover custom-data-bs-table">
                    <thead class="table-dark">
                            ...
                            <tr>
                                ...
                                <td data-label="{{ __('locale.Crypto Currency')}}" class="text-uppercase">{{__($practiceLog->crypto->name)}}</td>
                                <td data-label="{{ __('locale.Crypto Symbol')}}" class="text-uppercase">{{__($practiceLog->crypto->symbol)}}</td>
                                <td data-label="{{ __('locale.Amount')}}">{{__(getAmount($practiceLog->amount))}} {{$practiceLog->pair}}</td>
                                <td data-label="{{ __('locale.In Time')}}">{{showDateTime($practiceLog->in_time, 'd M, Y h:i:s')}}</td>
                                ...
                                <td data-label="{{ __('locale.Date')}}">{{showDateTime($practiceLog->created_at, 'd M, Y h:i:s')}}</td>
                            </tr>
                            @empty
                                <tr>
