...
// ==================== Bot Result Button Script ==================== //
$(document).on('click', '.run-bot', function () {
  let botId = $(this).data('id');
alert("Came In")
  $.ajax({
    url: "/bot-result", // make sure your route matches this
    type: "POST",
    data: {
    ...
    success: function (response) {
      alert(response.message || "Bot result executed successfully!");
